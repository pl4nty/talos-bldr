...
FROM --platform=$BUILDPLATFORM ghcr.io/siderolabs/ca-certificates:v1.11.0 AS image-ca-certificates

FROM --platform=$BUILDPLATFORM ghcr.io/siderolabs/fhs:v1.11.0 AS image-fhs
